...
const PROVIDER_CONFIG: Record<string, {
  ...
  groq: {
    ...
    instructions: 'Click "Create API Key", give it a name, and copy the key.',
  },
  openrouter: {
    label: 'OpenRouter',
    ...
    instructions: 'Click "Create Key", set a name and optional credit limit, then copy it.',
  },
  venice: {
    label: 'Venice',
    ...
    instructions: 'Generate an API key in your Venice settings and copy it.',
  },
  kimi: {
    label: 'Kimi (Moonshot)',
    ...
    instructions: 'Create an API key in the Moonshot console and copy it.',
  },
  mistral: {
    label: 'Mistral',
    ...
    instructions: 'Click "Create new key", give it a name, and copy it.',
  },
  gemini: {
    label: 'Google Gemini',
    ...
    instructions: 'Click "Create API key", select or create a project, then copy the key.',
  },
};
