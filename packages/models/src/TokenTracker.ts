...
const PRICING_TABLE: Array<{ prefix: string; pricing: ModelPricing }> = [
  ...
  { prefix: 'gpt-5.4-mini',      pricing: { inputPerMillion: 0.6,   outputPerMillion: 2.4   } },
  { prefix: 'gpt-5.4-nano',      pricing: { inputPerMillion: 0.15,  outputPerMillion: 0.6   } },
  { prefix: 'gpt-5.4',           pricing: { inputPerMillion: 7.5,   outputPerMillion: 30    } },
  { prefix: 'gpt-5.2',           pricing: { inputPerMillion: 7.5,   outputPerMillion: 30    } },
  { prefix: 'gpt-5.1',           pricing: { inputPerMillion: 7.5,   outputPerMillion: 30    } },
  { prefix: 'gpt-5-mini',        pricing: { inputPerMillion: 0.6,   outputPerMillion: 2.4   } },
  { prefix: 'gpt-5-nano',        pricing: { inputPerMillion: 0.15,  outputPerMillion: 0.6   } },
  { prefix: 'gpt-5',             pricing: { inputPerMillion: 7.5,   outputPerMillion: 30    } },
  { prefix: 'gpt-4.5',           pricing: { inputPerMillion: 75,    outputPerMillion: 150   } },
  { prefix: 'gpt-4.1-mini',      pricing: { inputPerMillion: 0.4,   outputPerMillion: 1.6   } },
  { prefix: 'gpt-4.1-nano',      pricing: { inputPerMillion: 0.1,   outputPerMillion: 0.4   } },
  { prefix: 'gpt-4.1',           pricing: { inputPerMillion: 2,     outputPerMillion: 8     } },
  { prefix: 'gpt-4o-mini',       pricing: { inputPerMillion: 0.15,  outputPerMillion: 0.6   } },
  { prefix: 'gpt-4o',            pricing: { inputPerMillion: 2.5,   outputPerMillion: 10    } },
  ...
  { prefix: 'o4-mini',           pricing: { inputPerMillion: 1.1,   outputPerMillion: 4.4   } },
  { prefix: 'o3-mini',           pricing: { inputPerMillion: 1.1,   outputPerMillion: 4.4   } },
  { prefix: 'o3',                pricing: { inputPerMillion: 10,    outputPerMillion: 40    } },
  { prefix: 'o1-mini',           pricing: { inputPerMillion: 1.1,   outputPerMillion: 4.4   } },
  { prefix: 'o1',                pricing: { inputPerMillion: 15,    outputPerMillion: 60    } },
  // Google Gemini
  { prefix: 'gemini-2.5-pro',    pricing: { inputPerMillion: 1.25,  outputPerMillion: 10    } },
  { prefix: 'gemini-2.5-flash',  pricing: { inputPerMillion: 0.15,  outputPerMillion: 0.6   } },
