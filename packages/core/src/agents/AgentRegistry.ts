...
export class AgentRegistry {
  ...
  create(input: CreateAgentInput): AgentDefinition {
    ...
    const agent: AgentDefinition = {
      ...
      ...(input.maxChildrenPerRun !== undefined && { maxChildrenPerRun: input.maxChildrenPerRun }),
      ...(input.maxSpawnDepth !== undefined && { maxSpawnDepth: input.maxSpawnDepth }),
  ...
  update(id: string, input: UpdateAgentInput): AgentDefinition {
    ...
    const updated: AgentDefinition = {
      ...
      ...(input.maxChildrenPerRun !== undefined && { maxChildrenPerRun: input.maxChildrenPerRun === null ? undefined : input.maxChildrenPerRun }),
      ...(input.maxSpawnDepth !== undefined && { maxSpawnDepth: input.maxSpawnDepth === null ? undefined : input.maxSpawnDepth }),
