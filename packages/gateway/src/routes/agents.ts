    ...
    schema: {
      body: {
        ...
        properties: {
          ...
          maxChildrenPerRun:   { type: 'integer', minimum: 0, maximum: 100 },
          maxSpawnDepth:       { type: 'integer', minimum: 0, maximum: 10 },
    ...
    schema: {
      body: {
        ...
        properties: {
          ...
          maxChildrenPerRun: { oneOf: [{ type: 'integer', minimum: 0, maximum: 100 }, { type: 'null' }] },
          maxSpawnDepth:     { oneOf: [{ type: 'integer', minimum: 0, maximum: 10 }, { type: 'null' }] },
